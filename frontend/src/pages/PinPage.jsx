                            ...
                            <div className="rounded-full h-12 w-12 bg-gray-300 flex items-center justify-center text-lg font-bold text-gray-700 shadow-md">
                             ...
                             <form className="flex-1 flex items-center space-x-3 ml-4">
                                <input
                                    ...
                                    className="flex-1 border border-gray-300 rounded-lg p-2 text-gray-700 focus:outline-none focus:ring-2 focus:ring-red-400 shadow-sm transition-all"
                                    required />

                                     <button
                                    type="submit"
                                    className="cursor-pointer bg-red-500 hover:bg-red-600 text-white py-2 px-4 rounded-lg shadow-md transition-all duration-300"
                                >
                                    Add+
                                </button>
